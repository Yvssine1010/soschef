...
const DotMaterial = shaderMaterial(
  {
    ...
    bgColor: new THREE.Color('#0f2a3f'),
    mouseTrail: null,
    render: 0,
    rotation: 0,
    gridSize: 50,
...
function Scene() {
  ...
  useEffect(() => {
    dotMaterial.uniforms.dotColor.value.setHex(0xd4af37)
    dotMaterial.uniforms.bgColor.value.setHex(0x0f2a3f)
    dotMaterial.uniforms.dotOpacity.value = 0.05
  }, [dotMaterial])
